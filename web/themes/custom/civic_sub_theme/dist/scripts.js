...
Drupal.behaviors.civic_sub_theme_slider = {attach: function (context, settings) {
// phpcs:ignoreFile
/**
 * Slider component.
 */
...
Drupal.behaviors.civic_sub_theme_alert = {attach: function (context, settings) {
/**
 * Alert component.
 *
...
Drupal.behaviors.civic_sub_theme_tooltip = {attach: function (context, settings) {
/**
 * @file
 * Tooltip component.
 */
...
Drupal.behaviors.civic_sub_theme_tabs = {attach: function (context, settings) {
/**
 * @file
 * Tabs component.
 */
...
Drupal.behaviors.civic_sub_theme_table_of_contents = {attach: function (context, settings) {
/**
...
Drupal.behaviors.civic_sub_theme_single_filter = {attach: function (context, settings) {
/**
 * @file
...
Drupal.behaviors.civic_sub_theme_group_filter = {attach: function (context, settings) {
/**
 * @file
...
Drupal.behaviors.civic_sub_theme_table = {attach: function (context, settings) {
/**
 * @file
 * Table component.
 */
...
Drupal.behaviors.civic_sub_theme_demo_button = {attach: function (context, settings) {
/**
...
Drupal.behaviors.civic_sub_theme_chip = {attach: function (context, settings) {
/**
 * @file
 * Chip component.
 */
...
Drupal.behaviors.civic_sub_theme_button = {attach: function (context, settings) {
/**
 * @file
 * Button component.
 */
...
Drupal.behaviors.civic_sub_theme_skip_to_target = {attach: function (context, settings) {
/**
 * @file
...
Drupal.behaviors.civic_sub_theme_scrollspy = {attach: function (context, settings) {
/**
 * @file
 * Scrollspy component.
 *
...
Drupal.behaviors.civic_sub_theme_responsive = {attach: function (context, settings) {
/**
 * @file
...
Drupal.behaviors.civic_sub_theme_platform = {attach: function (context, settings) {
/**
 * @file
 * Platform utility.
 */
...
Drupal.behaviors.civic_sub_theme_layout = {attach: function (context, settings) {
/**
 * @file
 * Layout component.
 */
...
Drupal.behaviors.civic_sub_theme_flyout = {attach: function (context, settings) {
/**
 * @file
 * Flyout component.
 *
...
Drupal.behaviors.civic_sub_theme_collapsible = {attach: function (context, settings) {
/**
 * @file
