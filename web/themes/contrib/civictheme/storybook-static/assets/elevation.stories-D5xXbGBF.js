// phpcs:ignoreFile
import{t as c,D as l,a as d,T as s}from"./twig-CcN5Lhas.js";import"./_commonjsHelpers-C4iS2aBk.js";d(s);s.cache(!1);const a=t=>t,u=(t={})=>{const o=c.twig({id:"/app/web/themes/contrib/civictheme/components/00-base/elevation/elevation.stories.twig",data:[{type:"raw",value:`<div class="story-elevation-wrapper">
...
`,position:{start:262,end:262}}],precompiled:!0});o.options.allowInlineIncludes=!0;try{return a(o.render({attributes:new l,...t}))}catch(p){return a("An error occurred whilst rendering /app/web/themes/contrib/civictheme/components/00-base/elevation/elevation.stories.twig: "+p.toString())}},m={title:"Base/Elevation",component:u},e={parameters:{layout:"centered"}};var n,r,i;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  parameters: {
    layout: 'centered'
  }
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const w=["Elevation"];export{e as Elevation,w as __namedExportsOrder,m as default};
